...
<form action="detail_proses.php" method="post">
    ...
    <table>
        <tr>
            ...
            <td>
            <select class="input-data" name="detail_transaksi_id">
        ...
        <tr>
            <td>Jumlah</td>
            <td><input type="text" name="detail_jumlah" class="input-data" value="<?php echo $row['detail_jumlah']; ?>"></td>
        </tr>
        <tr>
            <td>Barang</td>
            <td>
            <select class="input-data" name="detail_barang_id">
                        <option value="">--Silahkan Pilih--</option>
                        <?php
                        require_once "inc/koneksi.php";
